...
public class NbkrController {

  private final NbkrService nbkrService;

  @Inject
  public NbkrController(NbkrService nbkrService) {
  ...
  public void updateRates(ActionRequest request, ActionResponse response) throws AxelorException {
    try {
      ...
      response.setNotify("Rates updated successfully.");
